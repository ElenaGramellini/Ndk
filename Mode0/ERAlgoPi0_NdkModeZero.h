...
#ifndef ERTOOL_ERALGOPI0_NDKMODEZERO_H
#define ERTOOL_ERALGOPI0_NDKMODEZERO_H
...
namespace ertool {
  ...
  /**
     \class ERAlgoPi0_NdkModeZero
     @brief Algorithm to reconstruct Pi0 events using a Log-Likelihood function.
     ertool::ERAlgoPi0_NdkModeZero aims at finding Pi0 events. Given a list of showers and tracks, \n
   ...
   */
  class ERAlgoPi0_NdkModeZero : public AlgoBase {
  
  public:

    /// Default constructor
    ERAlgoPi0_NdkModeZero(const std::string& name="Pi0");

    /// Default destructor
    ~ERAlgoPi0_NdkModeZero(){}
