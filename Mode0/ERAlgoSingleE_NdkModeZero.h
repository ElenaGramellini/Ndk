...
#ifndef ERTOOL_ERALGOSINGLEE_NDKMODEZERO_H
#define ERTOOL_ERALGOSINGLEE_NDKMODEZERO_H
...
namespace ertool {
  ...
  /**
     \class ERAlgoSingleE_NdkModeZero
     User custom ERAlgorithm class made by kazuhiro
   */
  class ERAlgoSingleE_NdkModeZero : public AlgoBase {
  
  public:

    /// Default constructor
    ERAlgoSingleE_NdkModeZero(const std::string& name="SingleE_NdkModeZero");

    /// Default destructor
    ~ERAlgoSingleE_NdkModeZero(){};
  ...
  protected:
    ...
    double _BDtTW ;
    // Keep track of number of protons found
    int _protons;
    double _p_mass;
