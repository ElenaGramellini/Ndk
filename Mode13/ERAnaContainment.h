/**
 * \file ERAnaContainment.h
 *
 * \ingroup Mode13
 * 
 * \brief Class def header for a class ERAnaContainment
 *
 * @author elenag
 */
...
#ifndef ERTOOL_ERANACONTAINMENT_H
#define ERTOOL_ERANACONTAINMENT_H
...
namespace ertool {
  ...
  /**
     \class ERAnaContainment
     User custom Analysis class made by kazuhiro
   */
  class ERAnaContainment : public AnaBase {
  
  public:

    /// Default constructor
    ERAnaContainment(const std::string& name="ERAnaContainment");

    /// Default destructor
    virtual ~ERAnaContainment(){}
