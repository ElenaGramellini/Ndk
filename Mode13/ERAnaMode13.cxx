...
namespace ertool {
  ...
  void ERAnaMode13::ProcessBegin()
  {
    ...
    _ana_tree->Branch("_proton_x"     ,&_proton_x     ,"_proton_x/D     ");
    _ana_tree->Branch("_proton_y"     ,&_proton_y     ,"_proton_y/D     ");
    _ana_tree->Branch("_proton_z"     ,&_proton_z     ,"_proton_z/D     ");
    _ana_tree->Branch("_proton_t"     ,&_proton_t     ,"_proton_t/D     ");
    _ana_tree->Branch("_proton_px"    ,&_proton_px    ,"_proton_px/D    ");
    _ana_tree->Branch("_proton_py"    ,&_proton_py    ,"_proton_py/D    ");
    _ana_tree->Branch("_proton_pz"    ,&_proton_pz    ,"_proton_pz/D    ");
    ...
    _ana_tree->Branch("_mu_pz"        ,&_mu_pz        ,"_mu_pz/D        ");
    ...
    _ana_tree->Branch("_gamma_t"      ,&_gamma_t      ,"_gamma_t/D      ");
    _ana_tree->Branch("_gamma_px"     ,&_gamma_px     ,"_gamma_px/D     ");
    _ana_tree->Branch("_gamma_py"     ,&_gamma_py     ,"_gamma_py/D     ");
    _ana_tree->Branch("_gamma_pz"     ,&_gamma_pz     ,"_gamma_pz/D     ");
